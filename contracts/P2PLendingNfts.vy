...
OFFER_TYPE_DEF: constant(String[349]) = "Offer(uint256 principal,uint256 interest,address payment_token,uint256 duration,uint256 origination_fee_amount," \
                                        "uint256 broker_upfront_fee_amount,uint256 broker_settlement_fee_bps,address broker_address,address collateral_contract," \
                                        "uint256 offer_type,uint256[] token_ids,uint256 expiration,address lender,bool pro_rata,uint256 size,bytes32 tracing_id)"
